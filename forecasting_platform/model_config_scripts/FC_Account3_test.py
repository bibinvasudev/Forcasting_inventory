...
BACKWARD_FORECAST_PARAMETERS = ForecastTestParameters(
    model_config="ModelConfigAccount3", forecast_periods=9, prediction_month=pd.Timestamp(year=2020, month=3, day=1),
)
DEVELOPMENT_FORECAST_PARAMETERS = ForecastTestParameters(
    model_config="ModelConfigAccount3", forecast_periods=1, prediction_month=pd.Timestamp(year=2020, month=6, day=1),
)
...
class TestBackwardForecastAccount3:
...
class TestDevelopmentForecastAccount3:
