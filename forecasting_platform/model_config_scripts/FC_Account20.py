...
class ModelConfigAccount20(BaseModelConfig):
    """Model config for Account 20."""

    MODEL_NAME = AccountID("Account 20")

    CONTRACTS = [
        ContractID("Contract_60"),
        ContractID("Contract_476"),
        ContractID("Contract_585"),
        ContractID("Contract_582"),
    ]

    TRAINING_START = pd.Timestamp(year=2017, month=6, day=1)
