...
class ModelConfigAccount3(BaseModelConfig):
    """Model config for Account 3 and Account 4."""

    MODEL_NAME = AccountID("Account 3")

    CONTRACTS = [
        ContractID("Contract_225"),
        ContractID("Contract_227"),
        ContractID("Contract_623"),
        ContractID("Contract_629"),
        ContractID("Contract_630"),
        ContractID("Contract_632"),
        ContractID("Contract_633"),
        ContractID("Contract_635"),
    ]

    TRAINING_START = pd.Timestamp(2018, 1, 1)

    DEFAULT_FEATURES = default_features(lag=[1, 2, 3, 4, 5], moving_window=[3])
