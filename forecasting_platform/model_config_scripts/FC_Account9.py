...
class ModelConfigAccount9(BaseModelConfig):
    """Model config for Account 9."""

    MODEL_NAME = AccountID("Account 9")

    CONTRACTS = [ContractID("Contract_715"), ContractID("Contract_597")]
