...
class ModelConfigAccount12(BaseModelConfig):
    """Model config for Account 12."""

    MODEL_NAME = AccountID("Account 12")

    CONTRACTS = [ContractID("Contract_426"), ContractID("Contract_357")]
