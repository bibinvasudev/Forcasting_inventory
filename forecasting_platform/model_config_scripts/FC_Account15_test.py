...
BACKWARD_FORECAST_PARAMETERS = ForecastTestParameters(
    model_config="ModelConfigAccount15", forecast_periods=9, prediction_month=pd.Timestamp(year=2020, month=3, day=1),
)
...
class TestBackwardForecastAccount15:
...
DEVELOPMENT_FORECAST_PARAMETERS = ForecastTestParameters(
    model_config="ModelConfigAccount15", forecast_periods=1, prediction_month=pd.Timestamp(year=2020, month=6, day=1),
)
...
class TestDevelopmentForecastAccount15:
