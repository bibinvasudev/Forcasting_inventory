...
class ModelConfigAccount5(BaseModelConfig):
    """Model config for Account 5."""

    MODEL_NAME = AccountID("Account 5")

    TRAINING_START = pd.Timestamp(2018, 1, 1)
    DEFAULT_FEATURES = default_features(lag=[1, 2, 3], moving_window=[2], moving_avg=[2, 3, 4], moving_std_dev=[3])
    ...
    CONTRACTS = [
        ContractID("Contract_377"),
        ContractID("Contract_376"),
        ContractID("Contract_378"),
        ContractID("Contract_375"),
    ]
