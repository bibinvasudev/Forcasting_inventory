...
class ModelConfigAccount45(BaseModelConfig):
    """Model config for Account 45."""

    MODEL_NAME = AccountID("Account 45")

    CONTRACTS = [
        ContractID("Contract_612"),
        ContractID("Contract_613"),
        ContractID("Contract_611"),
    ]
    ...
    DEFAULT_FEATURES = default_features(
        lag=[1, 2], moving_window=[], moving_avg=[3, 5], moving_std_dev=[5], moving_non_zero=[]
    )
