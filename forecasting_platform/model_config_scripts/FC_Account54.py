...
class ModelConfigAccount54(BaseModelConfig):
    """Model config for Account 54 and 55."""

    MODEL_NAME = AccountID("Account 54")

    CONTRACTS = [
        ContractID("Contract_11"),
        ContractID("Contract_3"),
        ContractID("Contract_18"),
    ]
