...
class ModelConfigAccount468(BaseModelConfig):
    """Model config for Account 468."""

    MODEL_NAME = AccountID("Account 468")

    CONTRACTS = [
        ContractID("Contract_716"),
        ContractID("Contract_718"),
        ContractID("Contract_719"),
    ]

    TRAINING_START = pd.Timestamp(2017, 6, 1)

    DEFAULT_FEATURES = default_features(lag=[1, 2], moving_window=[3, 5])
