...
class ModelConfigAccount466(BaseModelConfig):
    """Model config for Account 466."""

    MODEL_NAME = AccountID("Account 466")

    CONTRACTS = [ContractID("Contract_714")]
