...
class ModelConfigAccount29(BaseModelConfig):
    """Model config for Account 29."""

    MODEL_NAME = AccountID("Account 29")

    CONTRACTS = [ContractID("Contract_601"), ContractID("Contract_546")]
